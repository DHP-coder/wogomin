...
<body>
        ...
        <div class="container-fluid">
          	...
          	<div class="nav navbar-expand-sm navbar-nav pull-right">
            	<ul class="navbar-nav mr-auto">
                	<li class="nav-item">
                  		<a class="nav-link" href="./homepage1">
	...
	<div class="w3-sidebar w3-bar-block w3-black w3-xxlarge" style="width:60px">
		<a href="./homepage" class="w3-bar-item "><i class="fa fa-bars" aria-hidden="true"></i></a>             
		<a href="./news" class="w3-bar-item "><i class="fa fa-newspaper-o" aria-hidden="true"></i></a> 
